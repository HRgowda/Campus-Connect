...
export default function ProfessorChannelDetailPage() {
  ...
  const leaveChannel = async () => {
    ...
    try {
      ...
      router.push("/professor/channels");
    } catch (error) {
  ...
  const archiveChannel = async () => {
    ...
    try {
      await axiosInstance.put(`/channels/${channel.id}`, { 
        is_archived: !channel.is_archived 
      });
      setChannel(prev => prev ? { ...prev, is_archived: !prev.is_archived } : null);
    } catch (error) {
  ...
  const canManageChannel = channel?.user_role === "owner" || channel?.user_role === "admin";
          ...
          <Card className="border-border">
            <CardContent className="p-12 text-center">
              <div className="space-y-4">
                ...
                <Button onClick={() => router.push("/professor/channels")}>
            ...
            <CardHeader>
              <div className="flex items-center gap-3">
                <Button
                  variant="ghost"
                  size="sm"
                  onClick={() => router.push("/professor/channels")}
                >
                  <ArrowLeft className="w-4 h-4 mr-2" />
                  Back
                </Button>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    {channel.is_archived && (
                      <Badge variant="outline" className="text-sm bg-gray-100 text-gray-600">
                        Archived
                      </Badge>
                    )}
                  </div>
  ...
  return (
    <div className="h-screen flex flex-col">
      <ChannelMessaging channel={channel} onClose={() => router.push("/professor/channels")} />
    </div>
  );
}
